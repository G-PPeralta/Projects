...
class Trivia extends Component {
  ...
  nextButton() {
    return (
      <NextButton type="button" data-testid="btn-next" onClick={ this.handClick }>
        Próxima
      </NextButton>
    );
  }
  ...
  question() {
    const { trivia, highlightRightAnswer, timeout, totalTime,
      ...
      <>
        ...
        <div>
          {!trivia.results ? (
            ...
            <div>
              <Category data-testid="question-category">
                {trivia.results[0].category}
              </Category>
              <h2
                data-testid="question-text"
                dangerouslySetInnerHTML={ this.getCleanText(
